...
class Res2Net(nn.Module):
    ...
    def __init__(self, layers, block=Bottle2neck, baseWidth = 16, scale = 4, num_classes=1000):
        self.inplanes = 64
...
def res2net50(pretrained=False, **kwargs):
    ...
    """
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth = 16, scale = 4, **kwargs)
    if pretrained:
